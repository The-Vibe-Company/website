  ...
  return (
    <section id="learn" className={spacing.section.padding}>
      <div className={spacing.container.default}>
        <div className={cn(layout.grid.cols2, spacing.gap.lg, "lg:gap-24 items-start")}>
          {/* Pillar 1 */}
          <motion.div
          ...
          >
            <div className={components.bordered.left}>
              <h2 className={cn(typography.label.default, "text-muted-foreground mb-8")}>
                01 — The Output
              </h2>
              <h3 className={cn(typography.display.section, "mb-8")}>
                WE<br />SHIP.
              </h3>
              <p className={cn(typography.body.default, "text-muted-foreground max-w-xl")}>
          ...
          >
            <div className={cn(components.bordered.left, "border-foreground border-l")}>
              <h2 className={cn(typography.label.default, "text-muted-foreground mb-8")}>
                02 — The Transfer
              </h2>
              <h3 className={cn(typography.display.section, "mb-8")}>
            ...
            <div className={cn(components.card.hover, "mt-12 p-8")}>
              <div className={cn(typography.fonts.mono, typography.label.small, "space-y-2 group-hover:opacity-100 transition-opacity")}>
                {[
                  "Thinking in Systems",
                  "The Art of Shipping",
                  "Vibe Engineering",
                  ...
                  <div
                    ...
                    className={cn(
                      "flex gap-4 pb-2",
                      index < 3 && components.divider.dashed
                    )}
                  >
