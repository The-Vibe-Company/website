...
4. **Pull in any prior critique** (optional signal): If a prior Impeccable critique or review artifact exists for the same target, read it and fold P0/P1 items into the polish list. The critique is one input among many. Do your own pass either way.
